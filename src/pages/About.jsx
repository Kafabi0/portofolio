...
export default function About() {
  ...
  <ShinyText text="Tentang Saya" disabled={false} speed={4} className="text-2xl sm:text-3xl md:text-4xl font-semibold mb-4 z-10" />

  {/* <h2 className="text-2xl sm:text-3xl md:text-4xl font-semibold mb-4 z-10 relative">
    Tentang Saya
  </h2> */}
  <p className="max-w-2xl text-base sm:text-lg md:text-xl z-10 mb-10">
